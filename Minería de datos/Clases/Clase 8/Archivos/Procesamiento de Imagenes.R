...
# Clustering basado en RGB y ubicacion

# Los datos de posicion estan en otra escala, si que nos normalizamos
...
# Cada cluster se representa por su color promedio
clusters$centers
colores <- rgb(red = clusters$centers[clusters$cluster,3],
